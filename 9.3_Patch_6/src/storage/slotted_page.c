			...
			DB_VALUE ** arg_values, int arg_cnt, void **ptr)
{
  ...
  *ptr = NULL;
  ...
  /*
   * seek slot without using spage_find_slot(), because the function will
   * raise assertion if the page is not a real slotted page.
   */
  ctx->slot =
    (SPAGE_SLOT *) ((char *) header + DB_PAGESIZE - sizeof (SPAGE_SLOT));
