...
#define ER_PLUGIN_JVM_LIB_NOT_FOUND                 -1159
#define ER_PLUGIN_CANNOT_START_JVM                  -1160
#define ER_PLUGIN_CANNOT_FIND_CLASS                 -1161
#define ER_PLUGIN_CREATE_REFERENCE_FAIL             -1162
#define ER_PLUGIN_GET_METHOD_FAIL                   -1163
#define ER_PLUGIN_CREATE_OBJECT_FAIL                -1164
#define ER_PLUGIN_JVM_FATAL_EXCEPTION               -1165
#define ER_PLUGIN_JVM_WARNING_EXCEPTION             -1166
