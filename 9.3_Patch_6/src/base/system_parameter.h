...
enum param_id
{
  ...
  PRM_ID_HA_APPLY_PLUGIN,
  PRM_ID_HA_APPLY_PLUGIN_JVM_OPTIONS,
  PRM_ID_HA_APPLY_PLUGIN_JAVA_HOME,
  PRM_ID_HA_APPLY_PLUGIN_MAX_MEM_SIZE,
  PRM_ID_HA_APPLY_PLUGIN_APPLY_LOG,
