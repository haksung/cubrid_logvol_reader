...
#define LOG_CHECK_LOG_APPLIER_PLUGIN(thread_p) \
  (thread_p != NULL &&	\
   logtb_find_client_type (thread_p->tran_index) == BOOT_CLIENT_LOG_APPLIER_PLUGIN)
#else
#define LOG_CHECK_LOG_APPLIER(thread_p) (0)
#define LOG_CHECK_LOG_APPLIER_PLUGIN(thread_p) (0)
#endif /* !SERVER_MODE */
