...
#define MSGCAT_SEMANTIC_INVALID_USE_FOR_UPDATE_CLAUSE	MSGCAT_SEMANTIC_NO(278)
#define MSGCAT_SEMANTIC_UNEXPECTED_NTH_ARGUMENT         MSGCAT_SEMANTIC_NO(279)
#define MSGCAT_SEMANTIC_TOO_MANY_ARGUMENT               MSGCAT_SEMANTIC_NO(280)
#define MSGCAT_SEMANTIC_TOO_FEW_ARGUMENT                MSGCAT_SEMANTIC_NO(281)
#define MSGCAT_SEMANTIC_UNEXPECTED_NAMED_ARGUMENT       MSGCAT_SEMANTIC_NO(282)
#define MSGCAT_SEMANTIC_MISSING_ARGUMENT                MSGCAT_SEMANTIC_NO(283)
#define MSGCAT_SEMANTIC_UNKNOWN_ARGUMENT                MSGCAT_SEMANTIC_NO(284)
