...
#define PRM_NAME_HA_APPLY_PLUGIN "ha_apply_plugin"

#define PRM_NAME_HA_APPLY_PLUGIN_JVM_OPTIONS "ha_apply_plugin_jvm_options"

#define PRM_NAME_HA_APPLY_PLUGIN_JAVA_HOME "ha_apply_plugin_java_home"

#define PRM_NAME_HA_APPLY_PLUGIN_MAX_MEM_SIZE "ha_apply_plugin_max_mem_size"

#define PRM_NAME_HA_APPLY_PLUGIN_APPLY_LOG "ha_apply_plugin_apply_log"
...
bool PRM_HA_APPLY_PLUGIN = false;
static bool prm_ha_apply_plugin_default = false;
static unsigned int prm_ha_apply_plugin_flag = 0;

bool PRM_HA_APPLY_PLUGIN_NONBLOCK = false;
static bool prm_ha_apply_plugin_nonblock_default = false;
static unsigned int prm_ha_apply_plugin_nonblock_flag = 0;

const char *PRM_HA_APPLY_PLUGIN_JVM_OPTIONS = "-Xrs -Xms512m -Xmx512m";
static const char *prm_ha_apply_plugin_jvm_options_default =
  "-Xrs -Xms512m -Xmx512m";
static unsigned int prm_ha_apply_plugin_jvm_options_flag = 0;

const char *PRM_HA_APPLY_PLUGIN_JAVA_HOME = "";
static const char *prm_ha_apply_plugin_java_home_default = "";
static unsigned int prm_ha_apply_plugin_java_home_flag = 0;

int PRM_HA_APPLY_PLUGIN_MAX_MEM_SIZE = 4096;
static int prm_ha_apply_plugin_max_mem_size_default = 4096;
static unsigned int prm_ha_apply_plugin_max_mem_size_flag = 0;

bool PRM_HA_APPLY_PLUGIN_APPLY_LOG = false;
static bool prm_ha_apply_plugin_apply_log_default = false;
static unsigned int prm_ha_apply_plugin_apply_log_flag = 0;
...
static SYSPRM_PARAM prm_Def[] = {
  ...
  {PRM_NAME_HA_PREFETCHLOGDB_MAX_PAGE_COUNT,
   ...
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_NAME_HA_APPLY_PLUGIN,
   (PRM_FOR_CLIENT | PRM_FOR_HA),
   PRM_BOOLEAN,
   (void *) &prm_ha_apply_plugin_flag,
   (void *) &prm_ha_apply_plugin_default,
   (void *) &PRM_HA_APPLY_PLUGIN,
   (void *) NULL, (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_NAME_HA_APPLY_PLUGIN_JVM_OPTIONS,
   (PRM_FOR_CLIENT | PRM_FOR_HA),
   PRM_STRING,
   (void *) &prm_ha_apply_plugin_jvm_options_flag,
   (void *) &prm_ha_apply_plugin_jvm_options_default,
   (void *) &PRM_HA_APPLY_PLUGIN_JVM_OPTIONS,
   (void *) NULL, (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_NAME_HA_APPLY_PLUGIN_JAVA_HOME,
   (PRM_FOR_CLIENT | PRM_FOR_HA),
   PRM_STRING,
   (void *) &prm_ha_apply_plugin_java_home_flag,
   (void *) &prm_ha_apply_plugin_java_home_default,
   (void *) &PRM_HA_APPLY_PLUGIN_JAVA_HOME,
   (void *) NULL, (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_NAME_HA_APPLY_PLUGIN_MAX_MEM_SIZE,
   (PRM_FOR_CLIENT | PRM_FOR_HA),
   PRM_INTEGER,
   (void *) &prm_ha_apply_plugin_max_mem_size_flag,
   (void *) &prm_ha_apply_plugin_max_mem_size_default,
   (void *) &PRM_HA_APPLY_PLUGIN_MAX_MEM_SIZE,
   (void *) NULL, (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
  {PRM_NAME_HA_APPLY_PLUGIN_APPLY_LOG,
   (PRM_FOR_CLIENT | PRM_FOR_HA | PRM_HIDDEN),
   PRM_BOOLEAN,
   (void *) &prm_ha_apply_plugin_apply_log_flag,
   (void *) &prm_ha_apply_plugin_apply_log_default,
   (void *) &PRM_HA_APPLY_PLUGIN_APPLY_LOG,
   (void *) NULL, (void *) NULL,
   (char *) NULL,
   (DUP_PRM_FUNC) NULL,
   (DUP_PRM_FUNC) NULL},
			    ...
			    SYSPRM_DATATYPE datatype)
{
  ...
  switch (datatype)
    ...
    case PRM_BIGINT:
      ptr = or_unpack_int64 (ptr, (INT64 *) & value->bi);
      break;
  ...
  for (prm_index = 0; prm_index < NUM_SESSION_PRM; prm_index++)
    {
      ...
      ptr = or_unpack_int (ptr, (int *) (&prm->flag));
