...
#define PRINT_CMD_PLUGIN        "plugin"
...
#define UTIL_OPTION_APPLYINFO                   "logreader"
...
#define APPLYLOG_PLUGIN_S                       'p'
#define APPLYLOG_PLUGIN_L                       "plugin"
#define APPLYLOG_SOURCE_DB_S                    's'
#define APPLYLOG_SOURCE_DB_L                    "source-db-name"
...
extern int logreader (UTIL_FUNCTION_ARG * arg_map);
