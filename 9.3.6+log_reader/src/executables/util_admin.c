...
static UTIL_ARG_MAP ua_Applylog_Option_Map[] = {
  ...
  {APPLYLOG_PLUGIN_S, {ARG_BOOLEAN}, {0}},
  {APPLYLOG_SOURCE_DB_S, {ARG_STRING}, {0}},
  {0, {0}, {0}}
};
...
static GETOPT_LONG ua_Applylog_Option[] = {
  ...
  {APPLYLOG_PLUGIN_L, 0, 0, APPLYLOG_PLUGIN_S},
  {APPLYLOG_SOURCE_DB_L, 1, 0, APPLYLOG_SOURCE_DB_S},
  {0, 0, 0, 0}
};
...
static UTIL_MAP ua_Utility_Map[] = {
  ...
  {APPLYINFO, CS_ONLY, 1, UTIL_OPTION_APPLYINFO, "logreader",
